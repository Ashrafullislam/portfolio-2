...
const AboutMe = () => {
  ...
  <div className="about-me-body ">
    ...
    <div >
          <a href='https://drive.google.com/file/d/1RtVTDIJFo4vNmyvEeeCk1fmPJhDrCK6a/view?usp=sharing'> <button className='btn  bg-gradient-to-r from-warning to-primary border-none shadow text-slate-200 hover:bg-gradient-to-r hover:from-primary hover:to-warning  ' > My CV  <FaArrowRight className='text-xl text-warning ml-3 ' /> </button> </a>
        </div>
        
    <div >
          <a href="https://drive.google.com/file/d/1wtYR2ImsnuM4O99HfxkAeiPslW6ED7SM/view?usp=sharing"> <button className='btn  bg-gradient-to-r from-warning to-primary border-none shadow text-slate-200 hover:bg-gradient-to-r hover:from-primary hover:to-warning  ' > Get My Resume <FaArrowRight className='text-xl text-warning ml-3 ' /> </button> </a>
        </div>
