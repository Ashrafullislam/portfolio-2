...
const AboutMe = () => {
  return (
    <section className='w-11/12 mx-auto mt-4 mb-24'>
      <h2 className="text-2xl text-center text-warning font-bold "> About Me ! </h2>
      <div className='mt-4'>
  ...
  <div className="about-me-body ">
    ...
    <h2 className='flex items-center gap-2'> <FaMapMarkerAlt className='text-warning'/>  Address :   Habiganj,Sylhet,Bangladesh   </h2>

    <div className='flex items-center lg:flex-row md:flex-row sm:flex-col flex-col  gap-2'> <FaUserGraduate className='text-warning' />
    Education: 
    <div>
    ...
    <div>
        <h2 className='flex  gap-2'> <FaHeadSideVirus className='text-warning font-bold text-2xl'/> Skills:  Html, Css, Bootstrap, React Bootstrap, Tailwind , Javascript , React.js ,  Node.js , Express.js , Rest Api, Firebase Authenticaion , MongoDb Database , Payment With Stripe   </h2>
     </div>
